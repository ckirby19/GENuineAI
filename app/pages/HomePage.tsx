...
import { GAME_ANSWER_TYPE, GAME_TYPE, GameAnswerType, GameType } from "../model"
    ...
    const handleNameSubmit = (e: React.FormEvent) => {
        ...
        if (props.username.trim()) {
            ...
            if (props.gameMode === GAME_TYPE.SINGLE_PLAYER){
                props.createLobby(3, GAME_ANSWER_TYPE.TEXT); // Currently only text game mode for single player
            }
        }
    };
