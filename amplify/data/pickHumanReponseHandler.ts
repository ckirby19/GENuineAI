...
export const handler: Schema["PickHumanResponse"]["functionHandler"] = async (
  ...
  context
    ...
    console.log('Pick Human Reponse Handler Started - received answers to choose from:', event.arguments.answers);
    ...
    const originalPrompt = event.arguments.originalPrompt;
    const answers = event.arguments.answers;
